 ...
 */
env::env_var::env_var(const std::string& name) : name(name) {
 ...
 */
std::string_view env::env_var::get_name() { return this->name; }

/**
 * Getter for `env_var.status`.
 */
bool env::env_var::get_status() const { return this->status; }
